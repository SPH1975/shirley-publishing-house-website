...
const journalLandingPage = (journal) => {
  ...
  const peerReviewPolicy = journal.id === 'national-research-journal' ? `<article class="journal-policy-card journal-policy-card--review" id="peer-review-process" aria-labelledby="journal-peer-review-title">
    ...
    <div class="hero-actions"><a class="btn btn-primary" href="/national-research-journal/peer-review-policy" aria-label="Read the complete National Research Journal peer-review policy">Read the Complete Peer-Review Policy</a><a class="btn btn-secondary" href="publication-ethics.html" aria-label="Read publication ethics policies">Publication Ethics</a></div></div>
  </article>` : '';
  ...
  const journalPolicyHighlights = journal.id === 'national-research-journal' ? `<section class="section journal-policy-highlights" aria-label="Author, peer-review and open-access information"><div class="container"><div class="journal-policy-highlights-grid">${informationForAuthors}${peerReviewPolicy}${openAccessPolicy}</div></div></section>` : '';
