...
const journalLandingPage = (journal) => {
  ...
  const journalNavigation = journal.id === 'national-research-journal' ? `<nav class="journal-local-nav" aria-label="National Research Journal page navigation"><div class="container"><a href="#journal-information">Journal Information</a><a href="#issn-verification">ISSN Verification</a><a href="#about-the-journal">About the Journal</a><a href="#open-access-policy">Open Access Policy</a><a href="#published-articles">Published Articles</a></div></nav>` : '';
