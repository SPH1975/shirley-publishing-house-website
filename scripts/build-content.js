...
const journalLandingPage = (journal) => {
  ...
  const openAccessPolicy = journal.id === 'national-research-journal' ? `<article class="journal-policy-card journal-policy-card--access" id="open-access-policy" aria-labelledby="journal-open-access-title">
    ...
    <div class="journal-open-access-copy"><p class="eyebrow">Reader access</p><h2 id="journal-open-access-title">Open-Access Policy</h2><p>All published content is immediately free to read and download—without registration, subscription or embargo—and may be shared and reused under its applicable Creative Commons licence.</p>
  ...
  const peerReviewPolicy = journal.id === 'national-research-journal' ? `<article class="journal-policy-card journal-policy-card--review" id="peer-review-process" aria-labelledby="journal-peer-review-title">
